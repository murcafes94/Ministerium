...
const generatedPath = path.join(tools, '.validate_stabilization_40.generated.mjs');

let source = fs.readFileSync(sourcePath, 'utf8');
const replacements = [
  ["requireText(build, 'versionCode 32', 'versionCode 3.1.1');",
   "requireText(build, 'versionCode 40', 'versionCode 4.0.0');"],
  ["requireText(build, \"versionName '3.1.1'\", 'versionName 3.1.1');",
   "requireText(build, \"versionName '4.0.0'\", 'versionName 4.0.0');"],
];
...
try {
  ...
  console.log('Ministerium 4.0 stabilization baseline OK');
} finally {
